...
def main():
    ...
    # raw = [[-40, 40], [-10, 10], [-80, 20]]
    raw = [[60, 140], [90, 110], [20, 120]]
    ...
    plt.tight_layout()
    plt.savefig('python_ai/voronoi_demo-bug1.png', dpi=150)
    plt.close()
    print("Diagram saved to python_ai/voronoi_demo-bug1.png")
