...
def main():
    ...
    # raw = [[-40, 40], [-10, 10], [-80, 20], [-40, -40], [-10, -10], [-20, -80], [40, -40], [10, -10], [80, -20], [40, 40], [10, 10], [20, 80],
    #        [-40, -40], [-10, -10], [-80, -20], [-40, 40], [-10, 10], [-20, 80], [40, 40], [10, 10], [80, 20], [40, -40], [10, -10], [20, -80]]
    raw = [[60, 140], [90, 110], [20, 120], [60, 60], [90, 90], [80, 20], [140, 60], [110, 90], [180, 80], [140, 140], [110, 110], [120, 180],
           [60, 60], [90, 90], [20, 80], [60, 140], [90, 110], [80, 180], [140, 140], [110, 110], [180, 120], [140, 60], [110, 90], [120, 20]]
    ...
    plt.tight_layout()
    plt.savefig('python_ai/voronoi_demo-bug4.png', dpi=150)
    plt.close()
    print("Diagram saved to python_ai/voronoi_demo-bug4.png")
